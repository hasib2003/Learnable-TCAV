# SPDX-FileCopyrightText: 2025 German Aerospace Center (DLR e.V.), Laines Schmalwasser
#
...
class FastCAVCaptumClassifier(DefaultClassifier):
    r"""Fast replacement of the Default classifier in captum for concept activation
    vectors calculation using mean differences. This implementation requires balanced
    classes. This implements the classifier proposed in the paper `FastCAV: Efficient
...
class FastCAVLinearModel(LinearModel):
    ...
    def __init__(self, **kwargs) -> None:
        super().__init__(train_fn=fastcav_train_linear_model__, **kwargs)


def fastcav_train_linear_model__(
    model: LinearModel,
...
class FastCAV:
    ...
    - **High-Dimensionality**: The method is analyzed in the context of
      ...
      discriminant solution
      <https://link.springer.com/article/10.1023/A:1018677409366>`_,
      and byi extension, the FastCAV solution.
