...
def args_train_base():
    ...
    parser.add_argument('--concepts_dir', type=str, help='Path to dir where the concepts are defined')
    parser.add_argument('--concept_config_train', type=str, help='Path to file containing concepts configuration required during training')
    parser.add_argument('--concept_config_val', required=False, type=str, help='Path to file containing concepts configuration used to generated evaluation reports (Default concept_config_train)')
    parser.add_argument('--target_activation_layer', type=str, default="avgpool", help='Activation layer to extract concepts from')
